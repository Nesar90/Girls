...
import com.simpleproject.girls.databinding.FragmentMakeupBinding;
...
public class MakeupFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentMakeupBinding.inflate(getLayoutInflater());
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        webserviceCaller.getBeautyContentList(new IResponseListener() {
            ...
            public void onSuccess(Object responseMessage) {
                binding.progressBarMakeup.setVisibility(View.INVISIBLE);
                ...
                for (int i = 0 ; i < contentList.size(); i++) {
                    if (contentList.get(i).getContentArtist().equals("makeup")) {
                ...
                binding.recyclerMakeup.setAdapter(contentAdapter);

                GridLayoutManager gridManager = new GridLayoutManager(getContext(), 3);
                binding.recyclerMakeup.setLayoutManager(gridManager);
            }
